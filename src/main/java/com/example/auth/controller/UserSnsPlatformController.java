...
@Slf4j
@Tag(name = "플랫폼 API", description = "사용자의 SNS 플랫폼 관리 API")
@RestController
...
public class UserSnsPlatformController {
    ...
    @GetMapping
    public ResponseEntity<?> getPlatforms(@RequestHeader("Authorization") String bearerToken) {
        ...
        return ResponseEntity.ok(ApiResponse.success(responseList, "SNS 플랫폼 목록을 성공적으로 조회했습니다."));
    }
    ...
    public ResponseEntity<?> addPlatform(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(mapToPlatformResponse(savedPlatform), "SNS 플랫폼이 성공적으로 등록되었습니다."));
    }
    ...
    public ResponseEntity<?> getPlatform(
        ...
        return ResponseEntity.ok(ApiResponse.success(mapToPlatformResponse(platform), "SNS 플랫폼 정보를 성공적으로 조회했습니다."));
    }
    ...
    public ResponseEntity<?> updatePlatform(
        ...
        return ResponseEntity.ok(ApiResponse.success(mapToPlatformResponse(updatedPlatform), "SNS 플랫폼 정보가 성공적으로 수정되었습니다."));
    }
    ...
    public ResponseEntity<?> deletePlatform(
        ...
        return ResponseEntity.ok(ApiResponse.success(null, "SNS 플랫폼이 성공적으로 삭제되었습니다."));
    }
